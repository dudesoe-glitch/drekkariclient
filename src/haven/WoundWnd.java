...
public class WoundWnd extends Widget {
	...
	public WoundPagina(Owner owner, Resource.Pagina pag) {
        ...
        public WoundPagina(Owner owner, Resource.Pagina pag, String extra) {
            this(owner, resdoc(pag.getres(), pag.text + extra));
        }
	...
	public List<ItemInfo> info() {
		...
		if(pag != null)
		    info.add(new WoundPagina(this, pag, curesString()));
		this.info = info;
	    }
	    return(info);
	}
